...
<section id="one" class="spotlights">
	<section>
		<a href="projects_description/20230526_demounityproject.md" class="image">
		...
		<div class="content">
			<div class="inner">
				...
				<ul class="actions">
					<li><a href="projects_description/20230526_demounityproject.md" class="button">Learn more</a></li>
				</ul>
			</div>
		</div>
	</section>
